...
import { CalendarDays, History, Logs, Plus, Trash2, UserPen, X } from 'lucide-react';
          ...
          <div className="metrics w-full h-[5vh] flex gap-2 items-center justify-start ">
            <div className="active1 h-full w-[40%] flex items-center justify-center ">
              <div className="status w-full flex gap-1 justify-start items-center">
                ...
                <div className="stat-written text-white text-sm h-full w-fit flex">100 orders</div>
              </div>
            </div>
          </div>
          <div className='partners-list-box h-[90vh] w-full p-4 overflow-auto flex flex-col gap-2'>
            <div className="IndiVidualPartner w-[100%] h-[6vh] bg-zinc-900 rounded-sm flex p-2">
              ...
              <div className="status w-[10%] md:w-[20%] flex gap-1 justify-start items-center">
                ...
                <div className="stat-written hidden md:flex text-white text-sm"> Assigned</div>
              </div>
              <div className='edit-delete md:w-[47%] w-[35%] flex items-center justify-end gap-2 text-black'>
                ...
                <div className="delete"><Button variant={'outline'} className='cursor-pointer'><History /><span className='md:inline hidden'>AssignmentHistory</span></Button></div>
              </div>
            </div>
            <div className="IndiVidualPartner w-[100%] h-[6vh] bg-zinc-900 rounded-sm flex p-2">
              <div className="individualname w-[50%] md:w-[30%] text-white h-full flex items-center justify-start px-1 md:text-sm text-[12px] overflow-hidden">order number</div>
